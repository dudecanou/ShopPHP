...
<form method="post">
    <td>
        ...
        <?php
            ...
            $query=mysql_query("select idclient, prenom, nom  from client;") or die("ERREUR DE CONNEXION");
...
<?php
    ...
    {
        $id = $_POST['id'];
        $query=mysql_query("select * from client where idclient='$id';") or die("ERREUR DE CONNEXION");
        ...
        echo "<input type='text' name='idclient' class='form-control' value ='$row[0]'>";
        echo "</div>";
        echo "</div>";
        
        echo "<div class='form-group'>";
        echo "<div class='col-sm-10'>";
        echo "<input type='text' name='prenom' class='form-control' value ='$row[1]'>";
        echo "</div>";
        echo "</div>";
        
        echo "<div class='form-group'>";
        echo "<div class='col-sm-10'>";
        echo "<input type='text' name='nom' class='form-control' value ='$row[2]'>";
        echo "</div>";
        echo "</div>";
        
        echo "<div class='form-group'>";
        echo "<div class='col-sm-10'>";
        echo "<input type='text' name='email' class='form-control' value ='$row[3]'>";
        echo "</div>";
        echo "</div>";
    ...
    if (isset($_POST['delete']))
{
    ...
    // requete sql
 $requete=mysql_query("delete from client where idclient='$id';") or die("ERREUR DE CONNEXION A LA TABLE recettes");
